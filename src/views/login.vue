<template>
    ...
    <img class="login-img" src="https://assets.maizuo.com/h5/mz-auth/public/app/img/logo.19ca0be.png" >
    ...
    <button class="login-btn-width" type="danger"> 登 录 <i class="iconfont icon-maizuologo"></i></button>
    </div>
</template>
<script>
